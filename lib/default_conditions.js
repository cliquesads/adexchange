...
var getInactiveError = require('./bid_requests').getInactiveError;
var getNativePlacementData = require('./markup_generator').getNativePlacementData;
...
DefaultConditionHandler.prototype.main = function(bid_request, auction_error, placement, secure, parent_tag_type, pubURL, callback){
    ...
    if (placement.type === 'native' && auction_error === getInactiveError(placement)){
        var nativeTestMarkup = getNativeTestMarkup(placement, pubURL);
