 ...
 */
ExchangeCLogger.prototype.auction = function(err, placement, request, response, winning_bid){
    var auction_meta = {
        type: "AUCTION",
        uuid: request.uuid
    };
    if (err){
        ...
        var new_meta = {
            ...
            bidobjid: winning_bid.bidobj__bidid.toString(),
            bidid: winning_bid.id.toString(),
            impid: winning_bid.impid.toString(),
            adid: winning_bid.adid.toString(),
            ...
            pub_clique: placement.parent_site.clique
        };
