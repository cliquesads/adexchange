...
// following functions process incoming request and parse out parameters
// to provide in bid request
...
function _get_single_imp_fake_bid_request(req, callback){
    var request_data;
...
function get_bids(bid_urls, req, cb){
    ...
    bid_urls.forEach(function(item){
        async_tasks.push(function(callback){
            ...
            _get_single_imp_fake_bid_request(req, function(err,request_data){
                if (err) throw err;
