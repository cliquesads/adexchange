...
var Auctioneer = function(bidders, bidder_timeout, mongo_connection, logger){
    ...
    1) Parsing incoming request
    2) Generating bid request
    3) Sending bid request to bidders
    4) Receiving bid responses
    5) Running auction & returning markup
    6) Sending win notice
...
Auctioneer.prototype.get_bids = function(req, cb){
...
Auctioneer.prototype.run_auction = function(bid_objects, callback){
