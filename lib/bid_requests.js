 ...
 *  */
var runSecondPriceAuction = function(bids, callback){
 ...
 * @param callback
 */
Auctioneer.prototype.runBottomUpAuction = function(placement, bid_objects, callback){
    ...
    subtree.push(placement.parent_site.clique);
...
Auctioneer.prototype.main = function(placement, request, response, callback){
    ...
    auctioneer.getBids(placement, request, function (e, result) {
        ...
        //now run the auction
        auctioneer.runBottomUpAuction(placement, result, function (er, winning_bid) {
