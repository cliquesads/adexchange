 ...
 * @constructor
 */
var _Auctioneer = function(bidders, bidder_timeout, logger){
...
exports._Auctioneer = _Auctioneer;
...
_Auctioneer.prototype._parse_bid_data = function(req, callback){
    var bid_data = {
        "id": uuid.v1(),
 ...
 * @privates
 */
_Auctioneer.prototype._parse_imp_and_site_data = function(placement, req, callback){
    var site_data = {
    ...
    var imp = {
        ...
        ext: {
            ...
            keywords: placement.parent_page.keywords
        }
    };
    ...
    if (placement.type === 'multiPaneNative'){
        for (var i=0; i < placement.multiPaneNative.count; i++){
            imps[i] = imp;
            imps[i] = +process.hrtime().join('');
        }
 ...
 * @private
 */
_Auctioneer.prototype._parse_device_data = function(req, callback){
 ...
 * @private
 */
_Auctioneer.prototype._parse_geo_data = function(req, callback){
    /*  */
    var ip = req.clientIp;
 ...
 * @private
 */
_Auctioneer.prototype._parse_user_data = function(req, callback){
 ...
 * @private
 */
_Auctioneer.prototype._create_bid_request = function(placement, req, cb){
 ...
 */
_Auctioneer.prototype.getBidders = function(placement){
    return this.bidders;
};
 ...
 */
_Auctioneer.prototype.getBids = function(placement, req, pubURL, cb){
    ...
    this._create_bid_request(placement, req, function(err, request_data) {
 ...
 */
_Auctioneer.prototype.send_win_notice = function(bid1, uuid, callback){
 ...
 * @param callback
 */
_Auctioneer.prototype.runAuction = function(placement, bid_objects, callback){
 ...
 * @param {AdServerURL} pubURL Parsed pubURL object
 * @param {Function} callback callback function to return impression response
 */
_Auctioneer.prototype.main = function(placement, request, response, pubURL, callback){
    var auctioneer = this;
