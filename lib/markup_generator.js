 ...
 *
 * @type {exports.getMultiPaneNativePlacementData}
 */
...
var getMultiPaneNativePlacementData = exports.getMultiPaneNativePlacementData = function(placement, formFactor){
    return {
        ...
        pane: {
            brandDisclosurePrefix: placement.pane.brandDisclosurePrefix,
            advertisementDisclosure: placement.pane.advertisementDisclosure,
            copyShortMaxLength: placement.pane.copyShortMaxLength,
            copyLongMaxLenth: placement.pane.copyLongMaxLength,
            template: placement.pane[formFactor].template,
            minImageHeight: placement.pane.minImageHeight,
            minImageWidth: placement.pane.minImageWidth
        },
        wrapper: {
            template: placement.wrapper[formFactor].template
        }
    }
};
