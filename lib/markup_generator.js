...
var getMarkup = exports.getMarkup = function(req, placement, secure, winningBidObject, bid_request, pubURL){
    ...
    var _formatAdserverUrl = function(impid, adm){
        ...
        adm = urls.expandURLMacros(adm, {
            bidid: bid_request.id.toString(), impid: impid, pid: pubURL.pid, ref: encodeURIComponent(req.get('Referrer')), aid: bid_request.id.toString()
        });
        return adm
    };
    ...
    switch (placement.type){
        case "native":
            ...
            adserverUrl = _formatAdserverUrl(impid, winningBidObject[impid].adm);
        ...
        case "multiPaneNative":
            ...
            for (var i = 0; i < sorted.length; i++){
                ...
                if (winningBidObject.hasOwnProperty(id)){
                    ...
                    adserverUrl = _formatAdserverUrl(id, winningBidObject[id].adm);
        ...
        default:
            ...
            impid = Object.keys(winningBidObject)[0];
            markup = _formatAdserverUrl(impid, winningBidObject[impid].adm);
    }
    return markup;
};
