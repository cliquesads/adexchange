...
var getAuctionData = exports.getAuctionDataMacros = function(rawImpUrl, winningBidObject, placement){
    ...
    return {
        ...
        'impid': impUrl.impid,
        'aid': impUrl.aid,
        'clearprice': URL_PARAM_CIPHER_KEY ? crypto.encodeFloatWithIntegerKey(winningBidObject['clearprice'], URL_PARAM_CIPHER_KEY, 2, '-', true): null,
        'price': URL_PARAM_CIPHER_KEY ? crypto.encodeFloatWithIntegerKey(winningBidObject['price'], URL_PARAM_CIPHER_KEY, 2, '-', true) : null,
