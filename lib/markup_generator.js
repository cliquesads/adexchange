 ...
 *
 */
var getAuctionData = exports.getAuctionDataMacros = function(pubUrl, impUrl, winningBidObject){
    ...
    switch (placement.type){
        case "native":
            ...
            if (pubURL.hasOwnProperty('auctionDataFields'){
                markup.auctionData = getAuctionData(auctionData = getAuctionData(pubURL,adserverUrl, winningBidObject);
            }
            ...
            for (var i = 0; i < sorted.length; i++){
                ...
                if (winningBidObject.hasOwnProperty(id)){
                    ...
                    if (pubURL.hasOwnProperty('auctionDataFields')){
                        ...
                        markup.auction_data.push(auctionData);
                    }
                }
            }
            debugMarkup = getDebugMarkup(pubURL,winningBidObject,bid_request, placement);
